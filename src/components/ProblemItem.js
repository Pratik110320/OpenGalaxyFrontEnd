...
import { Box, Heading, Text, Button, VStack, Textarea, Collapse, useColorModeValue } from '@chakra-ui/react';

const ProblemItem = ({ problem, onSolve }) => {
  ...
  return (
    ...
    >
      ...
      <Button mt={4} colorScheme="teal" onClick={() => setShowSolve(!showSolve)}>
        {showSolve ? 'Cancel' : 'Solve this Problem'}
      </Button>
